...
Define_Module(ClusteringService)

void ClusteringService::initialize()
{
    ItsG5BaseService::initialize();
    mVehicleController = &getFacilities().get_const<traci::VehicleController>();
}

void ClusteringService::trigger()
{
    Enter_Method("ClusteringService trigger");
    btp::DataRequestB req;
    req.destination_port = host_cast<ClusteringService::port_type>(getPortNumber());
